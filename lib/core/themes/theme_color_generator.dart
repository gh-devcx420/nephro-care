...
class ColorGenerator {
  ...
  static ColorScheme _generateLightScheme(HSLColor seedHsl) {
    return ColorScheme(
      ...
      // Light mode: Higher saturation (Gmail style)
      ...
      // errorContainer = Gmail's delete swipe background (dark saturated red)
      errorContainer: const Color(0xFFAD251C),
      // onErrorContainer = light text/icon on dark red background
  ...
  static ColorScheme _generateDarkScheme(HSLColor seedHsl) {
    return ColorScheme(
      ...
      // Dark mode: Lower saturation, more muted (Gmail style)
      ...
      // errorContainer = Gmail's delete swipe background (light desaturated pink)
      errorContainer: const Color(0xFFF1B7B5),
      // onErrorContainer = dark text/icon on light pink background

...
class WeightModalSheet extends StatefulWidget {
  ...
  static Future<T?> show<T>(BuildContext context, {WeightModel? weightInput}) {
    final colorScheme = Theme.of(context).colorScheme;

    return UIUtils.showNCBottomModalSheet<T>(
      context: context,
      title: weightInput == null ? 'Enter Weight Details:' : 'Edit Weight',
      primaryColor: colorScheme.primary,
      backgroundColor: colorScheme.surfaceContainerLow,
      dividerThickness: 2.0,
      dividerWidthFactor: 0.15,
      content: WeightModalSheet(weightInput: weightInput),
    );
  }
}
